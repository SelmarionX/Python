...
def logik():
    ...
    global numButton
    if len(numButton) == 9:
        tkinter.messagebox.showinfo("Игра окончена", "  Ничья!  ")
    else:
        end = False
        ...
        if end:
            if winner == 1:
                ...
                user = "X"
            tkinter.messagebox.showinfo("Игра окончена", "Выиграл " + user)
            begin(None)
...
ris0 = Button(root, width=10, height=5, bg="grey",
              command=lambda: click(ris0, 0))
ris0.place(x=0, y=0)
ris1 = Button(root, width=10, height=5, bg="grey",
              command=lambda: click(ris1, 1))
ris1.place(x=81, y=0)
ris2 = Button(root, width=10, height=5, bg="grey",
              command=lambda: click(ris2, 2))
ris2.place(x=162, y=0)

ris3 = Button(root, width=10, height=5, bg="grey",
              command=lambda: click(ris3, 3))
ris3.place(x=0, y=81)
ris4 = Button(root, width=10, height=5, bg="grey",
              command=lambda: click(ris4, 4))
ris4.place(x=81, y=81)
ris5 = Button(root, width=10, height=5, bg="grey",
              command=lambda: click(ris5, 5))
ris5.place(x=162, y=81)

ris6 = Button(root, width=10, height=5, bg="grey",
              command=lambda: click(ris6, 6))
ris6.place(x=0, y=162)
ris7 = Button(root, width=10, height=5, bg="grey",
              command=lambda: click(ris7, 7))
ris7.place(x=81, y=162)
ris8 = Button(root, width=10, height=5, bg="grey",
